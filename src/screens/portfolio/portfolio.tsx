        ...
        <Container>
            ...
            <Content>
                <MainWrapper>
                    ...
                    <Descr>
                        Игра на развитие памяти.Игра на развитие памяти.Игра на
                        развитие памяти.Игра на развитие памяти.Игра на развитие
                        памяти.Игра на развитие памяти.Игра на развитие
                        памяти.Игра на развитие памяти.Игра на развитие памяти.
                    </Descr>
